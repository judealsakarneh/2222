...
export default function EventsPage() {
  return (
    <>
      <Masthead
        kicker="Stage 04 — Events"
        title={<>An ecosystem, <span className="accent">not a sponsorship</span>.</>}
        lede="Five recurring formats built to earn the CTRL Room name — so that eventually the line reads &ldquo;CTRL Room presents&rdquo;, which is credibility pure sponsorship cannot buy."
      />

      <Act act="light" className="!pt-[var(--gap-act)]">
        <Wrap>
          <div className="max-w-[46rem]">
            <Eyebrow index="01">The formats</Eyebrow>
          ...
          <Reveal>
            <div className="grid gap-10 lg:grid-cols-12">
              <div className="lg:col-span-5">
                <Eyebrow index="02">The test</Eyebrow>
              ...
              <div className="lg:col-span-6 lg:col-start-7">
                ...
                <Lede className="mt-6">
                  ...
                  the answer is none of those, it is just paid branding — and we
                  do not do it.
                </Lede>
              </div>
            </div>
      ...
      <Act act="dark" className="!pt-0">
        <Wrap>
          <div className="border-t pt-[var(--gap-block)]" style={{borderColor: 'var(--line)'}}>
            <Title className="max-w-[18ch] text-[clamp(1.9rem,4.6vw,3rem)]">
