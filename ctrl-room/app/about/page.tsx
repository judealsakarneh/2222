...
export const metadata: Metadata = {
  title: 'About',
  description:
    'CTRL Room is not an Instagram page. Five stages built in order — attention, community, partnerships, events, leads — and the guardrails we will not break.',
};
  ...
  return (
    <>
      ...
      <Act act="light">
        <Wrap>
          <div className="max-w-[46rem]">
            <Eyebrow index="01">The roadmap</Eyebrow>
            ...
            <Lede className="mt-6">
              ...
              the trust the later stages depend on — so each phase is a
      ...
      <Act act="light" className="!pt-0">
        <Wrap>
          <div className="max-w-[46rem]">
            <Eyebrow index="02">Guardrails</Eyebrow>
            <Title className="mt-7 text-[clamp(2rem,4.8vw,3.4rem)]">
        ...
        <Wrap>
          <div className="grid gap-10 lg:grid-cols-12">
            <div className="lg:col-span-5">
              <Eyebrow index="03">Positioning</Eyebrow>
