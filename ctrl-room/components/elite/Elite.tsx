...
export function Elite() {
  return (
    <section id="elite" className="scroll-mt-24 py-[calc(var(--gap-act)/2)]">
      <div className="edge">
        <div className="grid items-center gap-x-16 gap-y-16 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5 lg:col-start-8">
            ...
            />
            <p className="mt-6 max-w-[36ch] text-[15px] leading-[1.62] text-grey-2">
            ...
            <ul className="mt-10">
              {ELITE_BENEFITS.map((b, i) => (
                <Reveal key={b} delay={i * 0.05}>
                  <li className="flex items-baseline gap-5 border-t border-white/[0.09] py-4 last:border-b">
        ...
        <div className="mt-[var(--gap-block)] grid gap-x-16 gap-y-10 lg:grid-cols-12">
          <div className="lg:col-span-3">
            ...
            <p className="mt-5 max-w-[26ch] text-[13.5px] leading-[1.55] text-white/55">
            ...
            {ENGINES.map((e, i) => (
              <Reveal key={e.title} delay={i * 0.05}>
                <div className="border-t border-white/[0.09] pt-5">
                  <span className="font-mono text-[10px] tracking-[0.14em] text-white/50">{e.n}</span>
                  <h3 className="mt-3 text-[17px] font-semibold tracking-[-0.015em] text-white">{e.title}</h3>
                  <p className="mt-2 max-w-[32ch] text-[13.5px] leading-[1.55] text-white/50">{e.body}</p>
                </div>
              </Reveal>
            ))}
          </div>
