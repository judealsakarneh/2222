...
export function Partners() {
  return (
    <Ground name="teal" id="partners" className="scroll-mt-24">
      <div>
          ...
          <div className="grid gap-x-16 gap-y-14 lg:grid-cols-12">
            <div className="lg:col-span-7">
              <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-[10px] tracking-[0.14em] t-2">07</span>
                <span className="text-[10px] font-medium uppercase tracking-[0.2em] t-2">Partners</span>
              </div>
              ...
              <p className="mt-8 max-w-[42ch] text-[15.5px] leading-[1.62] t-2">
            ...
            <ul className="lg:col-span-4 lg:col-start-9">
              {PARTNER_REACH.map((r, i) => (
                <Reveal key={r.label} delay={i * 0.05}>
                  <li className="border-t b-line-2 py-5 last:border-b">
                    <div className="flex items-baseline gap-5">
                      <span className="font-mono text-[10px] tracking-[0.14em] t-2">{r.n}</span>
                      <span>
                        <span className="block text-[15.5px] font-semibold t-1">{r.label}</span>
                        <span className="mt-1.5 block text-[13px] leading-[1.5] t-2">{r.body}</span>
                      </span>
                    </div>
                  </li>
                </Reveal>
